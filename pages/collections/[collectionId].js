...
const Collection = () => {
    ...
    // Получаем экземпляр контракта своей коллекции
    const nftCollection = useNFTCollection(collectionId);

    useEffect(() => {
        if (nftCollection) {
            // Вызов функции по получению экземпляра коллекции
            nftCollection
                .getAll()
                .then((nfts) => {
                    setNfts(nfts);
    ...
    // Инициализация модуля маркетплейса и передача его адреса
        ...
        <div className="overflow-hidden">
            ...
            <div className={style.midRow}>
                <div className={style.statsContainer}>
                    ...
                    <div className={style.collectionStat}>
                        <div className={style.statValue}>
                            <Image src={ethLogo} className={style.ethLogo} height={40} width={40} />
